...
// const subjects = require('../cache/Subjects.js');
...
databases = require('./samples/libapps/db-sample');
librarians = require('./samples/libapps/libn-sample');
guides = require('./samples/libapps/guides-sample');
subjects = require('./samples/libapps/subj-sample');
