...
getData script; it strips the individual styles and applies universal 
Dashboard styles to librarian's widgets (so far, just the schedule widget).

This should be run before the "utilities/updateSubjectCache" script; running the
...
const CleanCache = require(rootdir + '/classes/CleanCache');
